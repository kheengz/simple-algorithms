...
console.log("result : ", findConsecutiveRuns(3, array)); // [0,4,6,7];
const array2 = [1, 2, 3, 4, 5, 11, 10, 9, 8, 9, 10, 11, 7];
console.log("result : ", findConsecutiveRuns(4, array2)); // [ 0, 1, 5, 8 ]